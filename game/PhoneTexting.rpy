...
screen nvl_phonetext(dialogue):
    ...
    for id_d, d in enumerate(dialogue):
        if d.who == None: # Narrator
            ...
            if d.who == MC_Name:
                $ message_frame = "images/phone_icons/phone_send_frame.png"
            else:
                $ message_frame = "images/phone_icons/phone_received_frame.png"
...
style phoneFrame_frame:
    background Transform("images/phone_icons/phone_background.png", xcenter=0.5,yalign=0.5)
    foreground Transform("images/phone_icons/phone_foreground.png", xcenter=0.5,yalign=0.5)
